...
// https://maps.googleapis.com/maps/api/place/textsearch/json?query=***USER_INPUT***&location=***COORDS_HERE***&radius=10000&key=YOUR_API_KEY

// A model text search API call return
// 
// {
// "html_attributions" : [],
//   "results" : [
